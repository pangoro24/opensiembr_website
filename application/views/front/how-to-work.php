...
<v-main class="mt-10 mb-10">
	<v-container>
		<v-row>
			...
			<v-col cols="12" md="6">
				<v-img data-aos="fade-up" data-aos-delay="200" data-aos-once="true" src="https://picsum.photos/200/300" lazy-src="https://picsum.photos/200/300" max-width="100%" max-height="300"></v-img>
			</v-col>
		</v-row>
	</v-container>
</v-main>
